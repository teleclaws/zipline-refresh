...
extlinks = {
    "issue": ("https://github.com/teleclaws/zipline-refresh/issues/%s", "%s"),
    "commit": ("https://github.com/teleclaws/zipline-refresh/commit/%s", "%s"),
}
...
html_theme_options = {
    "github_url": "https://github.com/teleclaws/zipline-refresh",
    "external_links": [
        {"name": "Kavout", "url": "https://kavout.com"},
        {"name": "Documentation", "url": "https://kavout.com/academy/zipline-refresh"},
    ],
