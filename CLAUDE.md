# Zipline Refresh - Project Context for Claude

## Overview
Zipline is a Pythonic algorithmic trading library for backtesting trading strategies. This is the "Refresh" fork maintained by Kavout, based on zipline-reloaded (Stefan Jansen) after Quantopian closed in 2020. Key improvements: bcolz→Parquet migration, profiling-driven performance optimizations.

## Key Information
- **Python Version**: >= 3.10
- **Main Dependencies**: pandas >= 1.3, SQLAlchemy >= 2, numpy >= 1.23, pyarrow >= 14.0
- **Documentation**: https://kavout.com/academy/zipline-refresh
- **PyPI**: https://pypi.org/project/zipline-refresh/
- **Repository**: https://github.com/teleclaws/zipline-refresh
...
## Current Branch
`main` — Zipline Refresh fork with Parquet storage and performance optimizations. Sponsored by Kavout.
